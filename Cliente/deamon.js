...
class Deamon{
    ...
    async configurameElNodo(subred){
        ...
        try{
            ...
            [stdout, stderr] = await this.comandoBash(`sudo ip link add vxlan1 type vxlan id 42 dstport 4789 group 239.1.1.1 local ${this.miIP.split('/')[0]} proxy dev ${hostIF} ttl 20`);
